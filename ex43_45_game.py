...
Then create an Engine object with the Map object as an argument. Finally call 
the play() method on the Engine object.
Example:
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        while int(guess) != good_pod:
            ...
            {5} are left.
            """.format(guess, bad_escape_pods[0], bad_escape_pods[1], second_choice[0],
            ...
            if int(guess) != good_pod:
                text = """You jump into pod {0} and hit the eject button. The 
        ...
        text =  """You jump into pod {0} and hit the eject button. The pod 
...
class CombatRound(object):
    """
    Plays out combat between the player and a Gothon. It is a rock, paper, 
    scisors style of combat.
    ...
    def play(self):
        ...
        score = "\\n Player hits: " +  player_hits + " Gothon hits: " + gothon_hits
...
#                """
        ...
        result = player_action + gothon_action + " \\n" + result_descr
        return result
#        text_output = ex45.TextOutput(result, 60, 40)
#        text_output.display_text()